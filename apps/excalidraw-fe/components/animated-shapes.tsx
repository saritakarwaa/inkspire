  ...
  const shapes = [
    {
      type: "circle",
      size: 60,
      color: "bg-blue-500/20 dark:bg-blue-400/30",
      delay: 0,
      radius: 200,
      duration: 20,
    },
    {
      type: "rectangle",
      size: 50,
      color: "bg-purple-500/20 dark:bg-purple-400/30",
      delay: 2,
      radius: 250,
      duration: 25,
    },
    {
      type: "triangle",
      size: 40,
      color: "bg-orange-500/20 dark:bg-orange-400/30",
      delay: 4,
      radius: 180,
      duration: 18,
    },
    {
      type: "circle",
      size: 35,
      color: "bg-green-500/20 dark:bg-green-400/30",
      delay: 1,
      radius: 300,
      duration: 30,
    },
    {
      type: "rectangle",
      size: 45,
      color: "bg-pink-500/20 dark:bg-pink-400/30",
      delay: 3,
      radius: 220,
      duration: 22,
    },
    {
      type: "circle",
      size: 25,
      color: "bg-yellow-500/20 dark:bg-yellow-400/30",
      delay: 5,
      radius: 160,
      duration: 16,
    },
